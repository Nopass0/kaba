...
import TableLineFooter from '../TableLineFooter/index'
						...
						<>
							<tl.Header height={36}>
								<tl.HeaderRow className="bg-[#262626] color-[#808080] h-[36px] rounded-[10px]">
									...
									<tl.HeaderCell className={s.HeaderCell} style={{fontWeight: '400', fill: '#808080'}}>
										Реклам. сайт
									</tl.HeaderCell>
									<tl.HeaderCell
										style={{fontWeight: '400', fill: '#808080'}}
									...
									<tl.Row className="CheckBox" key={index} item={item}>
										...
										<tl.Cell>
											<Col width="auto">
												...
												<a target="_blank" rel="noopener noreferrer" className={s.AdSiteUrl} href={item.adSite.url}>
													{item.adSite.url}
												</a>
											</Col>
										</tl.Cell>
										<tl.Cell>
											<div className={s.Clicks}>
												<Clicks width="auto" count={item.adSite.status} />
											</div>
										</tl.Cell>
										<tl.Cell>
											<p
